...
const Header = ({ close, setclose, open , setOpen}) => {
  ...
  return (
    <div className="fixed left-0 top-0 z-[2222] px-[10px] w-full flex items-center h-[60px] xl:h-28 bg-[#252531] xl:bg-[#343438d2]">
      <div className="w-full h-full flex justify-between md:justify-around items-center">
        ...
        {/* Logo section */}
        <div className="xl:w-[310px] h-full bg-[#252531]  flex justify-center items-center gap-x-1.5">
          <Image
        ...
        {/* Contact section */}
        <div className="hidden md:flex items-center gap-x-[12px] ">
        ...
        {/* Hambarger */}
        <button onClick={handleHambarger} className="block md:hidden">
          <Image src={images.hambarger} alt="hambarger"></Image>
        </button>
      </div>
    </div>
  );
